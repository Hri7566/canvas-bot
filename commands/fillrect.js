...
module.exports = new Command(['fillrect', 'rect'], `Usage: PREFIX fillrect [pos1] [pos2] [width] [height] | Draw a filled rectangle.`, 4, (msg, bot, ctx) => {
    let pos1;
    let pos2;
    let pos3;
    let pos4;
    ...
    ctx.fillStyle = bot.settings.fillstyle;
